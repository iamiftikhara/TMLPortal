      ...
      200: function (data) {
        ...
        for (let i = 0; i < response.length; i++) {
          ...
          if (login_user_email == response[i].email) {
            actions = `
            <button class="btn btn-sm btn-outline-primary edit-member" data-member-id="${response[i].user_id}">Edit</button>
            <button class="btn btn-sm btn-outline-danger " disabled data-member-id="${response[i].user_id}">Remove</button>
          `
          } else {
            actions = `
            <button class="btn btn-sm btn-outline-primary edit-member" data-member-id="${response[i].user_id}">Edit</button>
            <button class="btn btn-sm btn-outline-danger remove-member" data-member-id="${response[i].user_id}">Remove</button>
          `
          }
